<div class="rounded-lg bg-gradient-to-r from-[var(--color-accent-mid-dark)] to-[var(--color-accent)] p-6 lg:p-8">
    <!-- Header -->
    <div class="mb-6">
        <a href="{{ route('sms_blast.index') }}" class="inline-flex items-center text-gray-500 hover:text-gray-700 dark:text-gray-400 mb-4">

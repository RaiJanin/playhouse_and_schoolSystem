<div class="mb-2 px-0 sm:px-12 md:px-20 lg:px-30">
    <div class="relative flex justify-between mb-2">
        ...
        <div id="filled-line" class="absolute top-1/2 left-0 h-1 bg-[var(--color-primary-light)] -translate-y-1/2 z-0 transition-all duration-500" style="width: 0%;"></div>
        <div class="relative z-10 flex justify-between w-full">
            <div id="step-1-num" class="w-8 h-8 rounded-full border-4 border-[var(--color-primary-light)] bg-[var(--color-accent-mid-dark)] flex items-center justify-center font-semibold text-[var(--color-primary)]">1</div>

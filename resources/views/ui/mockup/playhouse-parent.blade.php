...
<div class="p-4">
    ...
    <div class="mt-6 pt-4 border-t border-gray-800">
        <button id="add-guardian-checkbox" type="button" class="text-sm font-bold text-teal-700 bg-teal-200/50 hover:bg-teal-200 px-4 py-1.5 rounded-full transition-all duration-200 flex items-center gap-2 border border-teal-300">
				<i id="check-add-guardian-icon" class="fa-solid fa-plus text-teal-700 text-xs"></i>
				<p id="check-add-guardian-info" class="ml-2"></p>
			</button>
        <div id="guardian-form" hidden class="mt-4 space-y-4">
            <div>
            ...
            <!-- Remove button (matches children remove style) -->
            <div class="flex justify-end pt-2">
                <button id="removeGuardianBtn" type="button" class="remove-child text-sm font-bold text-red-700 bg-red-100 hover:bg-red-200 px-4 py-1.5 rounded-full border border-red-300 transition-all duration-200 flex items-center gap-2" style="display: none;">

...
<div class="p-4">
    ...
    <div class="space-y-4">
        <div>
            ...
            <input type="text" id="parentName" name="parentName" class="bg-[var(--color-primary-foggy)] w-full px-4 py-2 border-2 border-[#139eab] shadow rounded-lg font-semibold focus:outline-none focus:border-[#139eab] focus:shadow-none transition-all duration-300" placeholder="John" required />
        </div>
        <div>
            ...
            <input type="text" id="parentLastName" name="parentLastName" class="bg-[var(--color-primary-foggy)] w-full px-4 py-2 border-2 border-[#139eab] shadow rounded-lg font-semibold focus:outline-none focus:border-[#139eab] focus:shadow-none transition-all duration-300" placeholder="Doe" required />
        </div>
        <div>
            <label for="parentEmail" class="block text-base font-semibold text-gray-900 mb-2">Email Address</label>
            <input type="email" id="parentEmail" name="parentEmail" class="bg-[var(--color-primary-foggy)] w-full px-4 py-2 border-2 border-[#139eab] shadow rounded-lg font-semibold focus:outline-none focus:border-[#139eab] focus:shadow-none transition-all duration-300" placeholder="john.doe@email.com"/>
        </div>
        <div>
            ...
            <input type="tel" id="parentBirthday" data-birthday required class="bg-[var(--color-primary-foggy)] w-full px-4 py-2 border-2 border-[#139eab] shadow rounded-lg font-semibold focus:outline-none focus:border-[#139eab] focus:shadow-none transition-all duration-300" placeholder="MM / DD / YYYY" inputmode="numeric" autocomplete="bday" />
    ...
    <div class="mt-6 pt-4 border-t border-gray-800">
        ...
        <div id="guardian-form" hidden>
            <div>
                ...
                <input type="text" id="guardianName" name="guardianName" class="bg-[var(--color-primary-foggy)] w-full px-4 py-2 border-2 border-[#139eab] shadow rounded-lg font-semibold focus:outline-none focus:border-[#139eab] focus:shadow-none transition-all duration-300" placeholder="Will"/>
            </div>
            <div>
                ...
                <input type="text" id="guardianLastName" name="guardianLastName" class="bg-[var(--color-primary-foggy)] w-full px-4 py-2 border-2 border-[#139eab] shadow rounded-lg font-semibold focus:outline-none focus:border-[#139eab] focus:shadow-none transition-all duration-300" placeholder="Smith"/>
            </div>
            <div>
                <label for="guardianPhone" class="block text-base font-semibold text-gray-900 my-2">Phone Number</label>
                <input type="tel" id="guardianPhone" name="guardianPhone" class="bg-[var(--color-primary-foggy)] w-full px-4 py-2 border-2 border-[#139eab] shadow rounded-lg font-semibold focus:outline-none focus:border-[#139eab] focus:shadow-none transition-all duration-300" placeholder="09XXXXXXXXX" inputmode="tel"/>
            </div>

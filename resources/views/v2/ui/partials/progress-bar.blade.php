<div class="mb-2 px-0 sm:px-12 md:px-20 lg:px-30">
    <div class="relative flex justify-between mb-2">
        ...
        <div class="relative z-10 flex justify-between w-full">
            <div id="step-1-num" class="w-8 h-8 rounded-full border-4 border-teal-300 bg-amber-200 flex items-center justify-center font-semibold text-teal-500">1</div>
    ...
    <div class="flex justify-between px-0 max-w-full">
        ...
        <div id="step-5-text" class="text-sm font-medium text-gray-700">Menu</div>
        <div id="step-6-text" class="text-sm font-medium text-gray-700">Review</div>
    </div>
</div>

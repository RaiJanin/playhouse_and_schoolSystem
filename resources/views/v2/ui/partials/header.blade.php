<div class="sm:flex md:grid md:grid-cols-2 lg:grid-cols-3 py-[20px] px-4 bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-primary-mid-dark)] backdrop-blur-xs rounded-xl mb-[30px] shadow-sm z-20">
    ...
    <div class="lg:col-span-3 md:col-span-2">
        <div class="flex items-end justify-end">
            @if(Route::is('playhouse.checkout'))
                <a class="text-sm sm:text-base text-[var(--color-accent)] font-semibold underline decoration-2 underline-offset-2 decoration-white" href="{{ route('v2.playhouse.checkin.source')}}">Go to check in</a>
            @endif

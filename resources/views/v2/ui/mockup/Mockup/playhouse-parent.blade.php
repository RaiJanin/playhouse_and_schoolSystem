...
<div class="p-4">
    ...
    <div class="mt-4">
        <button id="set-as-guardian-checkbox" type="button" class="cursor-pointer p-2 text-sm hover:text-gray-500">
            <span class="flex items-center">
                <i id="check-set-as-guardian-icon" class="fa-regular fa-square text-red-500 text-xl"></i>
                <p id="check-set-as-guardian-info" class="ml-2"></p>
            </span>
        </button>
        <input type="hidden" name="setAsGuardian" id="setAsGuardian" value="0" />
    </div>

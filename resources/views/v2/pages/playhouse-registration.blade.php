    ...
    <div class="container max-w-full mx-auto">
        ...
        <div class="opacity-100 z-10">
            <div class="bg-gradient-to-r from-teal-100 to-teal-200 border border-gray-200 rounded-xl p-3 shadow max-w-full">
                <form id="playhouse-registration-form" class="overflow-x-hidden">
                    ...
                    <div class="flex items-center justify-center mb-3">
                        <div class="flex space-x-4 mt-8">
                            ...
                            <button type="button" id="next-btn" class="bg-teal-600 text-white px-6 py-2 rounded-md font-semibold text-lg cursor-pointer shadow hover:bg-teal-500 focus:ring-2 focus:ring-offset-2 ring-teal-500 disabled:cursor-not-allowed disabled:bg-teal-400 disabled:shadow-none transition-all duration-300">Next</button>
                ...
                <div id="qr-container" class="overflow-hidden hidden">
                    @include('v2.ui.playhouse-showQR')
                </div>
            </div>
        </div>
    </div>

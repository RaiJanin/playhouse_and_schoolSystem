...
@section('main-content')
    ...
    <div class="container max-w-full mx-auto">
        ...
        <div class="max-w-2xl mx-auto mt-8 sm:px-4 rounded-xl border-2 border-gray-100 shadow-md backdrop-blur-xl bg-gradient-to-r from-[var(--color-primary-transparent)] to-[var(--color-primary-foggy)] p-2 sm:p-4">
            <h2 class="text-2xl font-bold text-[#0d9984] mb-6 text-center">Check Out</h2>
            <div class="p-3 sm:p-6 backdrop-blur-md bg-white/60 border border-gray-50 rounded-xl shadow-md">
        ...
        <div id="search-results" class="max-w-full mx-auto mt-8 sm:px-4 rounded-xl border-2 border-gray-100 shadow-md backdrop-blur-xl bg-gradient-to-r from-[var(--color-primary-transparent)] to-[var(--color-primary-foggy)] p-2 sm:p-4 hidden">
            ...
            <div id="orders-list" class="p-3 sm:p-6 backdrop-blur-md bg-white/60 border border-gray-50 rounded-xl shadow-md grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="inline-block z-50 bg-white align-bottom rounded-2xl shadow-2xl transform transition-all sm:my-8 sm:max-w-4xl w-full relative overflow-hidden">
                    <div class="relative inline-block bg-white rounded-2xl p-8 w-full mx-4 justify-center text-center items-center">
                        ...
                        <button 
                            ...
                            class="mt-6 bg-gradient-to-t from-[var(--color-primary)] to-[var(--color-primary-light)] text-white font-bold py-3 px-8 rounded-lg hover:bg-[var(--color-primary-light)] transition-colors"
                        >
                            Close
                        </button>
                    </div>

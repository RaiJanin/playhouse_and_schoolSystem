...
@section('main-content')
    ...
    <div class="container max-w-4xl mx-auto">
        ...
        <div class="opacity-100 z-10">
            <div class="bg-gradient-to-r from-[var(--color-primary-foggy)] to-[var(--color-primary-transparent)] border border-gray-200 rounded-xl p-3 shadow">
                <form id="playhouse-registration-form" class="overflow-hidden">
                    ...
                    <div class="flex items-center justify-center mb-3">
                        <div class="flex space-x-4 mt-8">
                            ...
                            <button type="button" id="next-btn" class="bg-[#118b96] text-white px-6 py-2 rounded-md font-semibold text-lg cursor-pointer shadow hover:bg-[#139eab] focus:ring-2 focus:ring-offset-2 ring-[#139eab] disabled:cursor-not-allowed disabled:bg-[var(--color-primary-light)] disabled:shadow-none transition-all duration-300" disabled>Next</button>

                ...
                <form id="playhouse-registration-form" enctype="multipart/form-data" class="overflow-x-hidden">
                    ...
                    <div class="flex items-center justify-center mb-3">
                        <div class="flex space-x-4 mt-8">
                            ...
                            <button type="button" id="next-btn" class="bg-[var(--color-primary)] text-white px-6 py-2 rounded-md font-semibold text-lg cursor-pointer shadow hover:bg-[var(--color-primary-light)] focus:ring-2 focus:ring-offset-2 ring-[var(--color-primary)] disabled:cursor-not-allowed disabled:[var(--color-primary-light)] disabled:shadow-none transition-all duration-300">Next</button>

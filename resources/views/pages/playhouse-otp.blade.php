...
@section('main-content')
    ...
    <div class="container max-w-6xl mx-auto">
        ...
        @include('ui.partials.progress-bar', ['current' => 2])
            ...
            <div class="max-w-md mx-auto bg-white rounded-lg p-6 shadow-lg">
                ...
                <form class="space-y-4">
                    ...
                    <div class="flex space-x-4">
                        <a href="{{ route('playhouse.first') }}" class="flex-1 bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-lg transition-colors text-center">Back</a>
